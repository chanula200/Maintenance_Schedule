<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="slbndb.aspx.cs" Inherits="Routine_Maintenance.slbndb" %>
...
SELECT ntw_eng, 
 ...
 SUM(CASE WHEN status = 'close' THEN 1 ELSE 0 END) AS Closed FROM schedule left join lea2 on lea2.lea=schedule.lea where Platform='SLBN/SDH' and month(Start_Date)=month(@start)  and year(Start_Date)=year(@start)  group by ntw_eng
">
            <SelectParameters>
