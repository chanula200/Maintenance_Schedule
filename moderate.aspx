<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="moderate.aspx.cs" Inherits="Routine_Maintenance.moderate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentboddy" runat="server">
    <p style="font-size: large; font-weight: bold; color: #000066">
        Details of The Towers which Oerall Status is Moderate</p>
    <p style="font-size: large; font-weight: bold; color: #000066">
