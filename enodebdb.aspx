<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="enodebdb.aspx.cs" Inherits="Routine_Maintenance.enodebdb" %>
    ...
    <asp:Menu ID="NavigationMenu2" runat="server" CssClass="menu" EnableViewState="false" IncludeStyleBlock="false" Orientation="Horizontal" Width="100%">
        <Items>
            ...
            <asp:MenuItem Text="ITMC" Value="Antenna" NavigateUrl="~/itmcdb.aspx"></asp:MenuItem>
             <asp:MenuItem Text="eNodeB" Value="Antenna" NavigateUrl="~/enodebdb.aspx"></asp:MenuItem>
<asp:MenuItem Text="Tower Regional" Value="Antenna" NavigateUrl="~/towerdb2.aspx"></asp:MenuItem>
    ...
    <table class="auto-style14" style="font-size: large; font-weight: bold; color: #000066">
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" CssClass="auto-style42" Height="23px" ImageUrl="~/image/calendar.png" OnClick="ImageButton1_Click" Width="26px" />
            ...
            <td class="auto-style2" spellcheck="True" style="font-size: x-small; font-weight: normal; color: #FF0000">
                &nbsp;</td>
        </tr>
        <tr>
            <td class="auto-style6" spellcheck="True" style="color: #000099; font-size: small; font-weight: normal">
            ...
            <td class="auto-style4" spellcheck="True" style="color: #000099; font-size: small; font-weight: normal;">
                &nbsp;</td>
...
SELECT ntw_eng, 
 ...
 SUM(CASE WHEN status = 'close' THEN 1 ELSE 0 END) AS Closed FROM schedule left join lea2 on lea2.lea=schedule.lea where Platform='eNodeB' and month(Start_Date)=month(@start)  and year(Start_Date)=year(@start)  group by ntw_eng
">
            <SelectParameters>
