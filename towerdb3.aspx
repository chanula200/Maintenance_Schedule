<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="towerdb3.aspx.cs" Inherits="Routine_Maintenance.towerdb3" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentboddy" runat="server">
    ...
    <Items>
        ...
        <asp:MenuItem Text="ITMC" Value="Antenna" NavigateUrl="~/ipnwdb.aspx"></asp:MenuItem>
...
<table class="auto-style14" style="font-size: large; font-weight: bold; color: #000066">
    <tr>
        <td class="auto-style5" spellcheck="True" style="color: #000099; font-size: small; font-weight: normal">Year:
            <asp:TextBox ID="TextBox2" runat="server" Width="128px" CssClass="auto-style9"></asp:TextBox>
    ...
    <tr>
        <td class="auto-style6" spellcheck="True" style="color: #000099; font-size: small; font-weight: normal">&nbsp;</td>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataSourceID="SqlDataSource2" OnRowCommand="GridView2_RowCommand">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Pending" SortExpression="Pending">
                ...
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton5" runat="server" CommandName="Navigate4" Text='<%# Eval("Pending") %>' CommandArgument='<%#Eval("ntw_eng")%>'>LinkButtonn</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
...
SELECT ntw_eng, 
 ...
 SUM(CASE WHEN status = 'close' THEN 1 ELSE 0 END) AS Closed FROM schedule left join lea2 on lea2.lea=schedule.lea where Platform='Tower' and task='Tower Maintenance' and year(Start_Date)=year(@start)  group by ntw_eng
">
        <SelectParameters>
