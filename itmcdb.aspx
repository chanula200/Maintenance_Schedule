<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="itmcdb.aspx.cs" Inherits="Routine_Maintenance.itmcdb" %>
...
SELECT ntw_eng, 
 ...
 SUM(CASE WHEN status = 'close' THEN 1 ELSE 0 END) AS Closed FROM schedule left join lea2 on lea2.lea=schedule.lea where Platform='ITMC' and month(Start_Date)=month(@start)  and year(Start_Date)=year(@start)  group by ntw_eng
">
            <SelectParameters>
