<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Task_Details.aspx.cs" Inherits="Routine_Maintenance.Task_Details" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentboddy" runat="server">
    <table class="auto-style14" style="font-size: large; font-weight: bold; color: #000066">
        <tr>
            <td class="auto-style15" style="color: #000066; font-size: large; font-weight: bold">Task Details</td>
...
ON schedule.LEA= lea2.[LEA] where lea2.[LEA_Name]=@LEA_Name">
            ...
            <td class="auto-style20">
                ...
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:PMSConnectionString %>" SelectCommand="SELECT platform FROM Schedule where  platform!='enodeB'
UNION
SELECT 'All'
ORDER BY platform ASC;"></asp:SqlDataSource>
    ...
    <asp:Panel ID="Panel2" runat="server">
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Node_Name" SortExpression="Node_Name">
                    ...
                    <ItemTemplate>
                  <asp:HyperLink ID="HyperLink3" runat="server" Text='<%# Eval("Node_Name") %>' NavigateUrl='<%# "slbnform.aspx?Node_Name=" + Eval("Node_Name") + "&Platform=" + Eval("Platform") + "&End_Date=" + Eval("End_Date")+ "&Type=" + Eval("Type") %>'></asp:HyperLink>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PMSConnectionString %>" SelectCommand="GetTaskDetails" SelectCommandType="StoredProcedure" UpdateCommand="Update shedule set Remark=@REMARK, Remark_datetime= SYSDATETIME() where Node_Name=@Node_Name;">
            <SelectParameters>
