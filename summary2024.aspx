<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="summary2024.aspx.cs" Inherits="Routine_Maintenance.summary2024" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentboddy" runat="server">
    <br />
    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066" Text="2024"></asp:Label>
<br /><asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066" Text="Summary of IPNW"></asp:Label>
</p>
...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PMSConnectionString %>" SelectCommand="SELECT Month, [NW/WPNE],[NW/WPSW],[NW/WPSE],[NW/WPE],[NW/WPN],[NW/NWPE],[NW/NWPW],[NW/CPN],[NW/CPS],[NW/NCP],[NW/UVA],[NW/SAB],[NW/SPE],[NW/SPW],[NW/WPS],[NW/EP],[NW/NP-1],[NW/NP-2]
      FROM  
    (SELECT (status_datetime) as Month,lea2.designation,Schedule2024.status,Schedule2024.Task
FROM [PMS].[dbo].[Schedule2024] INNER JOIN lea2 ON Schedule2024.LEA=lea2.LEA 
WHERE Schedule2024.status='Close' and Platform='SLBN/SDH' and Start_Date &gt;=DATEFROMPARTS(YEAR(GETDATE()) - 1, 1, 1))
        AS tb  
    PIVOT  
    (  count(Task)
    ...
    FOR  
    designation 
        IN (  [NW/WPNE],[NW/WPSW],[NW/WPSE],[NW/WPE],[NW/WPN],[NW/NWPE],[NW/NWPW],[NW/CPN],[NW/CPS],[NW/NCP],[NW/UVA],[NW/SAB],[NW/SPE],[NW/SPW],[NW/WPS],[NW/EP],[NW/NP-1],[NW/NP-2])) as ptb 
...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:PMSConnectionString %>" SelectCommand="SELECT Month, [NW/WPNE],[NW/WPSW],[NW/WPSE],[NW/WPE],[NW/WPN],[NW/NWPE],[NW/NWPW],[NW/CPN],[NW/CPS],[NW/NCP],[NW/UVA],[NW/SAB],[NW/SPE],[NW/SPW],[NW/WPS],[NW/EP],[NW/NP-1],[NW/NP-2]
      FROM  
    (SELECT (status_datetime) as Month,lea2.designation,Schedule2024.status,Schedule2024.Task
FROM [PMS].[dbo].[Schedule2024] INNER JOIN lea2 ON Schedule2024.LEA=lea2.LEA 
WHERE Schedule2024.status='Close' and Platform='MSAN' and Start_Date &gt;=DATEFROMPARTS(YEAR(GETDATE()) - 1, 1, 1))
        AS tb  
    PIVOT  
    (  count(Task)
...
<p>
    ...
    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:PMSConnectionString %>" 
        SelectCommand="SELECT Month,[NW/WPNE],[NW/WPSW],[NW/WPSE],[NW/WPE],[NW/WPN],[NW/NWPE],[NW/NWPW],[NW/CPN],[NW/CPS],[NW/NCP],[NW/UVA],[NW/SAB],[NW/SPE],[NW/SPW],[NW/WPS],[NW/EP],[NW/NP-1],[NW/NP-2]
      FROM  
    (SELECT (status_datetime) as Month,lea2.designation,Schedule2024.status,Schedule2024.Task
FROM [PMS].[dbo].[Schedule2024] INNER JOIN lea2 ON Schedule2024.LEA=lea2.LEA 
WHERE Schedule2024.status='Close' and Platform='tower' and Start_Date &gt;=DATEFROMPARTS(YEAR(GETDATE()) - 1, 1, 1))
        AS tb  
    PIVOT  
    (  count(Task)
...
<p>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PMSConnectionString %>" SelectCommand="SELECT Month, [NW/WPNE],[NW/WPSW],[NW/WPSE],[NW/WPE],[NW/WPN],[NW/NWPE],[NW/NWPW],[NW/CPN],[NW/CPS],[NW/NCP],[NW/UVA],[NW/SAB],[NW/SPE],[NW/SPW],[NW/WPS],[NW/EP],[NW/NP-1],[NW/NP-2]
      FROM  
    (SELECT (status_datetime) as Month,lea2.designation,Schedule2024.status,Schedule2024.Task
FROM [PMS].[dbo].[Schedule2024] INNER JOIN lea2 ON Schedule2024.LEA=lea2.LEA 
WHERE Schedule2024.status='Close' and Platform='IPNW' and Start_Date &gt;=DATEFROMPARTS(YEAR(GETDATE()) - 1, 1, 1))
        AS tb  
    PIVOT  
    (  count(Task)
